      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-muted text-sm mt-2">
            Accedi per gestire i tuoi appuntamenti e scoprire i rituali riservati.
          </p>
        </div>

        {/* Clerk SignIn component with Premium Styling */}
        <div className="flex w-full justify-center 
          ...
          [&_.cl-userButtonPopoverCard]:rounded-2xl
